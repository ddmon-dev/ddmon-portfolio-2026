...
export const currentProjects: ProjectListItem[] = [
  {
    id: 'smartcaddie',
    image: '/current-projects/smartcaddie.png',
  ...
  {
    id: 'golfzoncloud',
    image: '/current-projects/golfzoncloud.png',
    title: '골프존클라우드 홈페이지',
    description:
  ...
  {
    id: 'v-portal',
    image: '/current-projects/v-portal.png',
    title: '백신정보포털',
    description:
  ...
  {
    id: 'rgb3d',
    image: '/current-projects/rgb3d.png',
