...
import { ProjectCard, DetailSection } from './project-card';
        ...
        <li>
          ...
          >
            <DetailSection title="Overview">
              <p>
                프리미엄 자동차 필름 브랜드 사이트와 시공점 발주·보증서 발급
                시스템, 관리자 어드민으로 구성된 B2B 웹 서비스입니다.
              </p>
            </DetailSection>
            ...
            <DetailSection title="Tech Stack">
              <p>Next.js 14, React, Supabase(Auth/DB/Storage/RPC), Tailwind CSS, Gabia Cloud, Nginx, Kakao Alimtalk</p>
            </DetailSection>
          </ProjectCard>
        </li>
        <li>
          ...
          >
            ...
            <DetailSection title="Role">
              <p>
                PC 디자인을 제외한 반응형 UI 구현, 프론트엔드 개발, 관리자 CMS,
                DB 구조 설계와 데이터 정규화, 프로젝트 기획·관리를 담당했습니다.
              </p>
            </DetailSection>
            <DetailSection title="Problem">
              <p>
            ...
            <DetailSection title="Tech Stack">
              <p>Next.js 14, React, Supabase, Server Actions, Tailwind CSS, Gabia Cloud</p>
            </DetailSection>
          </ProjectCard>
        </li>
        <li>
