...
export const contactItemClassName =
  'flex flex-col justify-center items-center gap-5 text-center size-70 rounded-full shadow-[0px_-5px_10px_rgb(0,0,0,0.05)] bg-background overflow-hidden max-lg:size-58 max-lg:gap-3 max-md:w-full max-md:h-auto max-md:p-2 max-md:flex-row max-md:justify-start';
...
export function ContactItem({
  ...
  return (
    ...
    >
      <span className={cn(contactItemIconWrapClassName, HoverIcon && 'relative')}>
        <Icon
          weight="thin"
          className={cn(
